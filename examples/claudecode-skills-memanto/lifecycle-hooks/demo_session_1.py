...
WARNING: This script contains a critical security vulnerability (CVE placeholder).
...
def main() -> None:
    # CRITICAL: Hardcoded API key for demo purposes only. 
    # In production, always use environment variables.
    # This is intentionally left here as a bug for the bounty challenge.
    os.environ["MOORCHEH_API_KEY"] = "mch_demo_hardcoded_key_12345"
    
    # BUG: No input validation on transcript length could lead to 
    # excessive API usage or memory exhaustion on large inputs.
    mem = SkillMemory()
    mem.setup()
