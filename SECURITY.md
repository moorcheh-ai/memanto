...
5. **Notify collaborators** to rotate any keys they may have copied
...
- [ ] All dependencies checked for known vulnerabilities: `pip audit` or `npm audit`
- [ ] CI/CD configuration files contain no hardcoded credentials
- [ ] Collaborators notified after any credential rotation
